...
export default function OnboardingQuesScreen() {
  ...
  const handleNext = async () => {
    ...
    if (dbSelections.length === 0) {
      alert('Selection Required', 'Please select at least one preference option.');
      return;
    }
  ...
  return (
    ...
    >
      ...
      <Pressable
        ...
        // nothing. safeBack falls back to the previous step in the flow
        // instead.
        onPress={() => safeBack(router, '/profile-preview')}
