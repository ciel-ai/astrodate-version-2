    ...
    >
      ...
      <View style={[styles.container, { paddingTop: insets.top + 50, paddingBottom: insets.bottom + 16 }]}>
        ...
        >
          ...
          <Text style={[styles.bullet, { color: T.body }]}>• Email address and/or mobile number</Text>
          <Text style={[styles.bullet, { color: T.body }]}>• A brief personal bio or description</Text>

          <Text style={[styles.subSubTitle, { color: T.text }]}>Location Data</Text>
          <Text style={[styles.paragraph, { color: T.body }]}>
          ...
          <Text style={[styles.subSubTitle, { color: T.text }]}>Controlling Your Location</Text>
          <Text style={[styles.paragraph, { color: T.body }]}>
          ...
          <Text style={[styles.paragraph, { color: T.body }]}>We use the information we collect to:</Text>
          <Text style={[styles.bullet, { color: T.body }]}>• Generate your Vedic or Western astrology birth chart</Text>
          <Text style={[styles.bullet, { color: T.body }]}>• Calculate compatibility scores between you and other users</Text>
          ...
          <Text style={[styles.bullet, { color: T.body }]}>• Is encrypted in storage and transmission</Text>
          <Text style={[styles.bullet, { color: T.body }]}>• Is never sold to third parties</Text>
          <Text style={[styles.bullet, { color: T.body }]}>• Is not displayed publicly on your profile (only your astrological profile summary such as sun sign or compatibility score may be visible to other users, as per your settings)</Text>
          <Text style={[styles.bullet, { color: T.body }]}>• May be used in anonymized, aggregated form for platform analytics and compatibility algorithm improvements</Text>
          ...
          <Text style={[styles.bullet, { color: T.body }]}>• With other users: Your profile information (name, photos, astrological summary, bio) is visible to other users as part of normal platform operation</Text>
          <Text style={[styles.bullet, { color: T.body }]}>• With service providers: Trusted third-party providers who assist in operating the App (payment processors, analytics, cloud storage) and who are bound by confidentiality obligations</Text>
          <Text style={[styles.bullet, { color: T.body }]}>• For legal compliance: When required by law, court order, or government authority</Text>
          <Text style={[styles.bullet, { color: T.body }]}>• For safety: When we believe disclosure is necessary to prevent fraud, harm, or illegal activity</Text>
          <Text style={[styles.bullet, { color: T.body }]}>• In a business transfer: In the event of a merger, acquisition, or sale of assets, your data may be transferred with appropriate notice to you</Text>
